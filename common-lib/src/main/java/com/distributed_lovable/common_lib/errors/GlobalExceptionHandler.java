...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handlerBadRequest(ResourceNotFoundException ex)
    {
    ...
    @ExceptionHandler(MethodArgumentNotValidException.class) // for @Valid errors
    public ResponseEntity<ApiError> handlerBadRequest(MethodArgumentNotValidException ex)
    {
